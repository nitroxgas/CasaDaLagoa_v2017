            ...
            */
            ...
            switch (getArguments().getInt(ARG_SECTION_NUMBER)) {
                case 3:// Temperatura
                    ...
                    tela.getSettings().setBuiltInZoomControls(false);
                    ...
                    if (tempView != null) {
                       ...
                       /*
                        if (showGrafico) {
                            WebView tela = (WebView) findViewById(1001);
                            if (tela != null)
                                if (tela.getVisibility() == View.VISIBLE) {
                                    tela.setVisibility(View.INVISIBLE);
                                } else
                                    tela.setVisibility(View.VISIBLE);
                        }
                       */
                        ...
                        RemoteViews views = new RemoteViews(getBaseContext().getPackageName(), R.layout.casa_widget);
                        views.setTextViewText(R.id.appwidget_text, "Mudou...");
